    ...
    return (
        <Grid container>
            ...
            <Card sx={{ minWidth: '100%',textAlign:'center' }}>
                <CardContent>
                    <img src={"/img/camera.png"} className="img-responsive" style={{width:'100px',margin:'10px'}}/>
                </CardContent>
            </Card>
            </Grid>
            ...
            <Card sx={{ minWidth: '100%',textAlign:'center' }}>
                <CardContent>
                    <img src={"/img/gallery.png"} className="img-responsive" style={{width:'100px',margin:'10px'}}/>
                </CardContent>
            </Card>
            </Grid>
